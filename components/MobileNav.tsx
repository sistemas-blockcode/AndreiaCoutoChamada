      ...
      <Sheet>
        ...
        <SheetContent side="left" className="border-none bg-[#F1F5FB] text-[#2C0D73]">
          ...
          <div className="flex h-[calc(100vh-72px)] flex-col justify-between overflow-y-auto">
            <SheetClose asChild>
              <section className="flex h-full flex-col gap-6 pt-16 text-[#2C0D73]">
                      ...
                      <Link
                        ...
                        className={cn(
                          'flex gap-4 items-center p-4 rounded-lg w-full max-w-60',
                          {
                            ...
                            'text-[#2C0D73]': !isActive, // Cor padrão dos itens não ativos
                          }
                        )}
                      >
                        <item.Icon size="24" className={isActive ? 'text-white' : 'text-[#2C0D73]'} />
